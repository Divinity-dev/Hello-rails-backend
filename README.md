...
```sh
  git clone https://github.com/Divinity-dev/Hello-rails-backend
...
Feel free to check the [issues page](https://github.com/Divinity-dev/Hello-rails-backend/issues).
